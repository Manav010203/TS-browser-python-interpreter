...
- Supports `print()` and `input()` handling

## Setup
```bash
git clone https://github.com/Manav010203/TS-browser-python-interpreter.git
cd TS-browser-python-interpreter
npm install
npm run dev
